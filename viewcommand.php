        ...
        <div id="data">
            ...
            <?php
             require('dbcon.php');
                                ...
                                $result = mysqli_query($conn, "SELECT * FROM `command` ");
                                
                                $numrows= mysqli_num_rows($result);
                           if ($numrows == 0)
                        {
                        echo "<p>There is no command information</p>";
                         }?>
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <a href="updatecommand.php?dates=<?php echo $dates?>"><strong
                                style="color:green; ">Update</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a onclick="return confirm('Do u want to remove?')"
                            href="do_remove.php?id=<?php echo $id; ?>"><strong style="color: red">Delete</strong></a>
                        <?php
...
?>
                ...
                <?php
 $db=mysqli_connect("localhost","root","","cms");
 $sqli="update command set reading=1 where  reading=0";
