        ...
        <div id="data">
            ...
            <?php
             require('dbcon.php');
                                ...
                                $result = mysqli_query($conn, "SELECT * FROM `student` WHERE `status`='noncafeteria'");
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <a onclick="return confirm('Do u want send to cafeteria?')"
                            href="do_cafeee.php?username=<?=$row['username']?>"><strong style="color: red">send to
                                cafeteria</strong></a>
                        <?php
