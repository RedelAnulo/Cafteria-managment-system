...
<html>
 ...
 if (isset($_GET['dates'])) {
     $dates=$_GET['dates'];
                ...
                <form action="updatecommandsubmit.php?dates=<?php echo $dates?>" name="myForm" method="post">
                    <?php
             require('dbcon.php');
            $result = mysql_query("SELECT * FROM command where dates='$dates'")or die(mysql_error());
